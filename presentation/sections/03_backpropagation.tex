...
\begin{frame}{Feedforward Neural Network Structure}
    \begin{center}
        \includegraphics[width=0.85\textwidth]{figures/feedforward_nn_diagram.png}
    \end{center}
...
\begin{frame}{Activation Functions}
    ...
    \begin{itemize}
        ...
        \item Gradient is 1 for $x > 0$, so no vanishing
...
\begin{frame}{What Do Feedforward Networks Learn?}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{figures/mnist_weights.png}
    \end{center}
